using Braphia.NotificationDispatcher.Consumers;
using Braphia.NotificationDispatcher.Database;
using Braphia.NotificationDispatcher.Repositories;
...
builder.Services.AddScoped<ILaboratoryRepository, SqlLaboratoryRepository>();
